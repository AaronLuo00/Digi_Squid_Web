  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-4">
        ...
        >
          Your comprehensive guide to the DigitalSquid Games ecosystem. Learn about our game mechanics, 
      ...
      >
        ...
        <p className="text-gray-400">
          DigitalSquid Games combines AI-driven gameplay with blockchain rewards to create 
